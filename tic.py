...
pygame.init() #initializing pygame is neccessary

#pygame setup
screen=pygame.display.set_mode((WIDTH,HEIGHT))
pygame.display.set_caption('THAPAR TIC TAC TOE')
...
class AI:
    ...
    def rnd(self,board):
        ...
        ind=random.randrange(0,len(empty_sqrs))
        return empty_sqrs[ind]
    
    def minimax(self,board,maximizing):
        case=board.final_state()
        #case1 player1 wins
        if case==1:
            return 1,None #value,move

        #case2 player2 i.e. ai wins
        if case==2:
            return -1,None
...
class Game:
    ...
    def isover(self):
        self.board.final_state(show=True)!=0 or self.board.isfull()
